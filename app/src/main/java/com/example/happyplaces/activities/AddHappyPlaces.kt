...
class AddHappyPlaces : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(toolbar_add_happy_places) // Use the toolbar to set the action bar.
        supportActionBar?.setDisplayHomeAsUpEnabled(true) // This is to use the home back button.
        // Setting the click event to the back button
        toolbar_add_happy_places.setNavigationOnClickListener {
            onBackPressed()
        }
            ...
            R.id.btn_save ->{
                when {
                    ...
                    saveImageToInternalStorage == null -> {
                        ...
                        if(mHappyPlaceDetails==null){
                            val addHappyPlaces=dbHandler.addHappyPlaces(happyPlaceModel)
                            if (addHappyPlaces > 0) {
            ...
            if (requestCode == GALLERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@AddHappyPlaces, "Failed!", Toast.LENGTH_SHORT).show()
                    }
                }
